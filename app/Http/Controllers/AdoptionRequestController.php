...
class AdoptionRequestController extends Controller
{
   ...
   public function approveAdoption($id)
    ...
    {
        // Fetch all rejected adoption requests
        $rejectedRequests = AdoptionRequest::where('status', 'Rejected')->orderBy('created_at', 'desc')->get();

        


        // Return the view with the rejected adoption requests
